...
xmlhttp.open("GET","ddpay.php?q="+str,true);
xmlhttp.send();
}
</script>
...
<body>
<br><br><br>
<center><h1>Rent Payment Form</h1></center>
<br><br>
...
<tr>
  <td><span class="style3">Amount Paid: </span></td>
  <td><label>
...
<tr>
  <td><span class="style3">Account Number: </span></td>
  <td><label>
    <input name="t1" type="text" id="t1">
  </label></td>
</tr>
<tr>
  <td><span class="style3">Date Paid: </span></td>
  <td><label>
