...
if($_REQUEST['sub'])
 {
 $sel=mysql_query("SELECT Lfirstname,password from Landlord where Lfirstname='$name'");
 
 $arr=mysql_fetch_array($sel);
 if($arr['Lfirstname']==$name and $arr['password']==$pass)
   {
   session_start();
   $_SESSION['eid']=$name;
...
<div><br><h1>LANDLORD LOGIN PAGE</h1>
</div>
<br><br><br><br><br>
...
<a href="../index.php">No account yet? SIGNUP</a>
</div>
